...
public class TranslateActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        add_function = (ImageButton)findViewById(R.id.add_translate);
        add = (Button)findViewById(R.id.add_trans);
        add.setOnHoverListener(new View.OnHoverListener() {
            @Override
        ...
        add_function.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
